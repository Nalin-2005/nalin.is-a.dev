			...
			<div class="container">
				<div class="row px-5 px-xl-2 justify-content-center">
					<div class="col-lg-8 mb-5 text-center">
						<p class="mb-0 pb-0 lead">Github Profiles is a platform that displays GitHub profiles with modern material card design it using GitHub API with following features.</p>
					</div>
					...
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Search any GitHub profile by their username.</h5>	
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Displays User Information</h5>
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Displays User Profile Image.</h5>	
					</div>

					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Displays User Bio.</h5>	
						<p class="mb-0 pb-0"> If Bio is not kept, null will be returned.</p>	
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Displays Followers, Following and Number of Repository.</h5>	
						<p>One can directly visit the repo from the user's profile simply by clicking on the repo name.</p>
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3">Repositories are ordered alphabetically.</h5>
					</div>
					<div class="col-lg-12 mb-5 text-center">
						<h5 class="mb-3" style="font-weight: bold; font-size: x-large;"><u>Project Studio</u></h5>
						<div class="img-wrap">
							<img src="img/projects/github-profiles/gh-pro.png" alt="To-Do Screenshot">
						</div>	
					</div>
					
					<div class="col-lg-10 mb-5 text-center">
						<p class="mb-0 pb-0 lead">This project is closed.<br/> This project is not licensed sa it uses GitHub API.</p>
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3"><a href="https://github.com/cmulay/github-profiles.git">Visit Project Repo</a></h5>
					</div>
					<div class="col-md-4 mb-5 text-center" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
						<h5 class="mb-3"><a href="https://cmulay-githubprofiles.netlify.app/">Preview Project</a></h5>
					</div>
				</div>		
			</div>			
		</div>
