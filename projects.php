...
<body class="over-hide">
	...
	<div class="animsition">	
		...
		<ul class="case-study-images">
			<li>
				<div class="img-hero-background no-blur"></div> 
				<h2 class="fullscreen-image no-blur">Notes App</h2>
				<div class="hero-number">01</div> 
				<div class="hero-number-fixed">03</div> 
			</li>
			<li>
				<div class="img-hero-background no-blur"></div> 
				<h2 class="fullscreen-image no-blur">To-Do App</h2>
				<div class="hero-number">02</div> 
			</li>
			<li>
				<div class="img-hero-background no-blur"></div> 
				<h2 class="fullscreen-image no-blur">GitHub Profiles</h2>
