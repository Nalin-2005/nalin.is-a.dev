...
<body>
	...
	<div class="animsition">
		...
		<div class="shadow-title parallax-top-shadow">About</div>
			...
			<div class="container z-bigger">
				...
				<div class="col-lg-7 padding-top" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.2s">
					<blockquote class="blockquote">
						<p class="lead-big color-white mb-0"><em>Let's invent tomorrow, rather than worrying about what happened yesterday.</em></p>
						<h6 class="mt-5"> - Steve Jobs</h6>
					</blockquote>
				</div>	
			</div>
		</div>
				...
				<div class="row px-5 px-xl-2">
					...
					<div class="col-md-4" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.1s">	
						<ul class="studio-list">
							...
							<li><p>HTML CSS </p></li>
							<li><p>JS PHP</p></li>
							<li><p>Java | Advance Java</p></li>
							<li><p>VB.NET</p></li>
						</ul>	
					</div>	
					<div class="col-md-4" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.15s">	
						<ul class="studio-list">
							<li><p>Google Assistant Developer</p></li>
							<li><p>Android Developer [Java]</p></li>
							<li><p>iOS Developer [Swift 5 - Moderate]</p></li>
					...
					<div class="col-md-4" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.15s">	
						<ul class="studio-list">
							<li><p>Database: MySQL, Access, Oracle, SQLite</p></li>
							<li><p>Database: Firebase, AWS, MongoDB [Beginner]</p></li>
							<li><p>Video Editing [FCPX & Adobe Premiere Pro]</p></li>
							<li><p>Audio Production [Adobe Audition]</p></li>
							<li><p>Designer [Adobe Illustrator & Adobe XD]</p></li>
						</ul>	
					</div>
				</div>		
			</div>				
		...
		<div class="social-fixed">
			<i class="hover-target fa fa-github" aria-hidden="true">
				<a href="https://github.com/cmulay" class="hover-target"> GitHub</a>
			</i>
		</div>
		<div class="copyr">
			2020 &copy; <a href="https://github.com/cmulay" class="hover-target">Chinmay Mulay</a>
		</div>
