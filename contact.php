...
<body>
	...
	<div class="animsition">	
		...
		<div class="nav">
			<div class="nav__content">
				...
				<ul class="nav__list">
					...
					<li class="nav__list-item active-nav"><a href="contact.php" class="hover-target animsition-link">Contact</a></li>
				</ul>
			</div>
		</div>	
		...
		<div class="section padding-top-bottom over-hide z-bigger background-dark-3 footer">
			<div class="shadow-on-footer" data-scroll-reveal="enter bottom move 30px over 0.5s after 0.1s">codewithchin@gmail.com</div>
				...
				<div class="row">
					<div class="col-12 text-center z-bigger py-5">
						<div class="footer-lines">
							<a href="mailto:codewithchin@gmail.com" class="hover-target"><h4>Email Me</h4></a>
						</div>
					</div>
				</div>
			</div>		
